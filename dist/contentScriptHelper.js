...
chrome.runtime.onMessage.addListener((request) => {
    ...
    if(type === 'layoutData' && data){
        ...
        _storeInLocalStorage(data)
    }
})

const layoutData = JSON.parse(localStorage.getItem('_pixelPerfectlayoutData'))
runWebPageScript(layoutData)
chrome.runtime.sendMessage({
    type: 'updatedActiveLayoutData',
    data: layoutData
})